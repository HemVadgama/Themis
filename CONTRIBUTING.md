...
Use `docs/protocols.md` for protocol work and `docs/configuration.md` when changing the schema. Update example smoke tests and user documentation with public-interface changes. Report bugs or modeling concerns with the feedback issue form; include a resolved config and Themis version when possible.
