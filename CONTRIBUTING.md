...
Good first contributions include a protocol plus deterministic tests, a documented linear scenario, a metric derived from existing state, an artifact-based visualizer, or an input adapter that does not bypass validation.
