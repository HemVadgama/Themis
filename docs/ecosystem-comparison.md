...
| [JOSS review criteria](https://joss.readthedocs.io/en/latest/review_criteria.html) | Research software review expects a statement of need, documentation, tests, contribution guidance, and research impact. | Build adoption evidence and validation studies before seeking publication. | Engineering foundations and honest scope; not yet a claim of JOSS readiness. |
